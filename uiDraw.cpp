...
*************************************************************************/
void ogstream::drawPiece(int x, int y, bool white, Rect rectangle[], int num) const
{
...
*************************************************************************/
void ogstream::drawKing(int pos, bool white)
{
   Rect rectangles[] =
   {
   ...
   drawPiece(xFromPosition(pos), yFromPosition(pos), white, rectangles, 7);
}
...
*************************************************************************/
void ogstream::drawQueen(int pos, bool white)
{
   Rect rectangles[] =
   {
   ...
   drawPiece(xFromPosition(pos), yFromPosition(pos), white, rectangles, 9);
}
...
*************************************************************************/
void ogstream::drawRook(int pos, bool white)
{
   Rect rectangles[] =
   {
   ...
   drawPiece(xFromPosition(pos), yFromPosition(pos), white, rectangles, 5);
}
...
*************************************************************************/
void ogstream::drawKnight(int pos, bool white)
{
   Rect rectangles[] =
   {
...
*************************************************************************/
void ogstream::drawBishop(int pos, bool white)
{
   Rect rectangles[] =
   {
   ...
   drawPiece(xFromPosition(pos), yFromPosition(pos), white, rectangles, 6);
}
...
*************************************************************************/
void ogstream::drawPawn(int pos, bool white)
{
   Rect rectangles[] =
   {
